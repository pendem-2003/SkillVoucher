            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-800 mt-1">
                  Our team will verify your payment within <strong>1-2 hours</strong>. Once verified, you'll receive a notification and immediate access to your courses with a proper invoice.
                </p>
