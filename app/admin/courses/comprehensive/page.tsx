...
export default function ComprehensiveCoursePage() {
      ...
      for (const module of modules) {
        ...
        if (moduleResponse.ok) {
          ...
          for (const lesson of module.lessons) {
            ...
            await fetch(`/api/admin/modules/${createdModule.id}/lessons`, {
              method: 'POST',
              headers: { 'Content-Type': 'application/json' },
              body: JSON.stringify({
                title: lesson.title,
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Fill in all details including modules and lessons</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4 justify-end">
            ...
            <Button type="submit" disabled={saving} className="bg-gradient-to-r from-blue-600 to-purple-600">
              ...
              {saving ? 'Creating...' : 'Create Complete Course'}
            </Button>
          </div>
        </form>
      </div>
